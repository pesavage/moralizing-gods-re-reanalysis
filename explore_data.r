...
#expect_equal(n_known_absent, 12) #commented out since no longer true
#expect_equal(n_unknown, 490) #commented out since no longer true

#expect_true(abs(cor(dm$MG_known, dm$MG) - 0.97) < 0.01) #commented out since no longer true
...
#expect_true(abs(pop1 - 3891008) < 10000) #commented out since no longer true
#expect_true(abs(pop0 - 7756) < 100) #commented out since no longer true

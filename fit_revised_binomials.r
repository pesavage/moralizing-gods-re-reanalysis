...
#expect_equal(nrow(dm), 336) #commented out since no longer true
# 311 cases are left from the 801 originally
# but 25 more because we don't have to drop Lag1 = NA cases

# 27 NGAs in the reduced set #Increased from 26 originally (added "Valley of Oaxaca")
NGAs <- c(
  ...
  "Oro PNG",                    "Paris Basin",
  "Sogdiana",    "Susiana",
  "Upper Egypt", "Valley of Oaxaca", "Yemeni Coastal Plain"
)
